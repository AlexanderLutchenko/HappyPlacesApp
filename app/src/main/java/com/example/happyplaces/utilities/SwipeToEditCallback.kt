...
//Step32 Create a class for feature to swipe and edit the HappyPlace RecyclerView item

// For detail explanation of this class, look at below link
// https://medium.com/@kitek/recyclerview-swipe-to-delete-easier-than-you-thought-cff67ff5e5f6

//An abstract class that will be used for edit feature
abstract class SwipeToEditCallback(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
    ...
    private val backgroundColor = Color.parseColor("#82CD47")
    ...
    override fun onChildDraw(
        ...
        //Draw the colored edit background
